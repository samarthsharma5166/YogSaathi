...
import { orientationJob, dieticianSessionJob, yogaSessionJob } from './Schedular/Admin.Schedular.js';
...
import yogaCareRoutes from './routes/yogaCare.route.js';
...
app.use("/api/yogacare", yogaCareRoutes);
