                        ...
                        "parameters": [
                            {
                                "type": "document",
                                "document": {
                                    "link": "https://chatmitra.s3.ap-south-1.amazonaws.com/documents/fff_1777774153981.pdf",
                                    "filename": "fff_1777774153981.pdf"
                                }
                            }
                        ]
                    },
                ...
                components: [
                    ...
                    },
                    {
                        ...
                        "parameters": [
                            ...
                            {
                                "type": "text",
                                "text": "https://yogsaathi.com/price"
                            }
                        ]
                    }
                ]
...
export const subscription_offer_day_english = (number, name, image, days) => {
    return axios.post("https://backend.chatmitra.com/developer/api/send_message", {
        recipient_mobile_number: number,
        messages: [{
            kind: "template",
            template: {
                name: "subscription_offer_day_english",
                language: "en",
                components: [
                    {
                        "type": "header",
        ...
        console.log(`subscription_offer_day_english success for ${number}:`, response.data);
    }).catch(error => {
        console.error(`subscription_offer_day_english error for ${number}:`, error.response?.data || error.message);
    });
}